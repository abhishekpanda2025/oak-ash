  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-sans font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "bg-primary text-primary-foreground hover:bg-accent tracking-luxury uppercase rounded-none border-0 shadow-soft hover:shadow-elegant",
        luxuryOutline: "border border-foreground/30 text-foreground hover:border-primary hover:text-primary tracking-luxury uppercase rounded-none bg-transparent",
        luxuryGold: "bg-gradient-to-r from-gold to-gold-dark text-foreground tracking-luxury uppercase rounded-none shadow-elegant hover:shadow-soft",
      },
      size: {
