...
export const demoProducts: DemoProduct[] = [
  ...
  {
    id: "17",
    handle: "monaco-aviator-sunglasses",
    title: "Monaco Aviator Sunglasses",
    description: "Classic aviator sunglasses with gold metal frames and gradient brown lenses. Timeless elegance for any occasion.",
    price: 245,
    category: "eyewear",
    collection: ["eyewear", "new-in"],
    images: ["/placeholder.svg", "/placeholder.svg"],
    isNew: true,
    material: "Gold-Plated Metal, Polarized Lenses",
    care: "Store in protective case. Clean with microfiber cloth.",
  },
  {
    id: "18",
    handle: "riviera-cat-eye-frames",
    title: "Riviera Cat-Eye Frames",
    description: "Sophisticated cat-eye optical frames in classic black acetate. Elegant and versatile for everyday wear.",
    price: 189,
    category: "eyewear",
    collection: ["eyewear"],
    images: ["/placeholder.svg", "/placeholder.svg"],
    ...
    care: "Clean lenses with provided microfiber cloth.",
  },
  {
    id: "19",
    handle: "capri-oversized-sunglasses",
    title: "Capri Oversized Sunglasses",
    description: "Bold oversized sunglasses with tortoise shell pattern. Maximum UV protection with statement style.",
    price: 275,
    category: "eyewear",
    collection: ["eyewear", "new-in"],
    images: ["/placeholder.svg", "/placeholder.svg"],
    isNew: true,
    material: "Premium Acetate, UV400 Lenses",
    care: "Avoid extreme temperatures. Use protective case.",
  },
  {
    id: "20",
    handle: "windsor-optical-frames",
    title: "Windsor Optical Frames",
    description: "Refined rectangular optical frames in sleek black with subtle gold accents. Perfect for professional settings.",
    price: 165,
    category: "eyewear",
    collection: ["eyewear"],
    images: ["/placeholder.svg", "/placeholder.svg"],
    material: "Titanium & Acetate",
    care: "Handle with care. Clean regularly.",
  },
  {
    id: "21",
    handle: "malibu-sport-sunglasses",
    title: "Malibu Sport Sunglasses",
    description: "Lightweight wraparound sunglasses designed for active lifestyles. Anti-slip grip with polarized lenses.",
    price: 195,
    category: "eyewear",
    collection: ["eyewear"],
    images: ["/placeholder.svg", "/placeholder.svg"],
    isBestseller: true,
    material: "Lightweight TR90, Polarized Lenses",
    care: "Rinse after exposure to saltwater or sweat.",
  },
];
...
export const collections = [
  ...
  },
  {
    ...
    description: "Luxury sunglasses and optical frames for the discerning eye.",
    image: "/placeholder.svg",
  },
];
